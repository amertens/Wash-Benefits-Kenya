...
diar_n<-cbind(N.kids[,3],N.diar[25:48,4])

#Fix up this ordering
#diar_n<-diar_n[c(1,8,2:7,9,16,10:15,17,24,18:23),]
diar_t0_n<-diar_n[1:8,]
diar_t1_n<-diar_n[9:16,]
diar_t2_n<-diar_n[17:24,]
colnames(diar_t1_n)<-colnames(diar_t1_n)<-colnames(diar_t0_n)<-c("N","n")




####Prevalence for combined year 1 and 2 for supplimentary table
diarprev12 <-
  diar %>%
  subset(., !is.na(.$diar7d) & dcohort==1|!is.na(.$diar7d) &u36==1)  %>%
  filter(studyyear!=0) %>%
...
diar_t0_prev<-cbind(grouped.diarprev[1:8,4], grouped.diarprev[1:8,7], grouped.diarprev[1:8,8])%>%set_rownames(arms)
diar_t1_prev<-cbind(grouped.diarprev[9:16,4], grouped.diarprev[9:16,7], grouped.diarprev[9:16,8])%>%set_rownames(arms)
diar_t2_prev<-cbind(grouped.diarprev[17:24,4], grouped.diarprev[17:24,7], grouped.diarprev[17:24,8])%>%set_rownames(arms)


colnames(diar_t2_prev)<-colnames(diar_t1_prev)<-colnames(diar_t0_prev)<-c("Mean","95%CI.L","95%CI.U")
...
#save data
#-----------------------------------
diar_t0_n_A<-diar_t0_n
diar_t1_n_A<-diar_t1_n
diar_t2_n_A<-diar_t2_n
diar_t0_prev_A<-diar_t0_prev
diar_t1_prev_A<-diar_t1_prev
diar_t2_prev_A<-diar_t2_prev

diar_h1_pr_unadj_A<- diar_h1_pr_unadj
diar_h1_rd_unadj_A<-  diar_h1_rd_unadj
diar_h2_pr_unadj_A<- diar_h2_pr_unadj
diar_h2_rd_unadj_A<- diar_h2_rd_unadj
diar_h3_pr_unadj_A<- diar_h3_pr_unadj
diar_h3_rd_unadj_A<- diar_h3_rd_unadj
diar_h1_pr_adj_A<- diar_h1_pr_adj
diar_h1_rd_adj_A<-  diar_h1_rd_adj
diar_h2_pr_adj_A<- diar_h2_pr_adj
diar_h2_rd_adj_A<- diar_h2_rd_adj
diar_h1_pval_unadj_A<-  diar_h1_pval_unadj
diar_h2_pval_unadj_A<- diar_h2_pval_unadj
diar_h1_pval_adj_A<-  diar_h1_pval_adj
diar_h2_pval_adj_A<- diar_h2_pval_adj

save(diar_t0_n_A, diar_t1_n_A,diar_t2_n_A, diar_t0_prev_A, diar_t1_prev_A, diar_t2_prev_A, diar_h1_pr_unadj_A, diar_h1_rd_unadj_A, diar_h2_pr_unadj_A, diar_h2_rd_unadj_A, diar_h1_pr_adj_A, diar_h1_rd_adj_A, diar_h2_pr_adj_A, diar_h2_rd_adj_A,diar_h1_pval_unadj_A,diar_h2_pval_unadj_A,diar_h1_pval_adj_A,diar_h2_pval_adj_A, diar_h3_pr_unadj_A, diar_h3_rd_unadj_A, file="diar_Andrew.RData")
