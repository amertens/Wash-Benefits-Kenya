...
* and save the data
keep  clusterid hhid block tr Nlt18 momedu momage electricity dminwat  patedu agwork cementfloor ironroof improvedwater treatwat odmen odwom odch38 odchu3 latown impr_lat  humfeces wat_avail soap_avail     momedu_prim HHSmod_sev numHHs numPPL


compress
label data "Kenya enrollment analysis dataset (HH obs), created by 7-kenya-dm-table1.do"
saveold "~/dropbox/Kenya Primary Analysis/Data-selected/clean/washb-kenya-table1.dta", replace version(12)
outsheet using "~/dropbox/Kenya Primary Analysis/Data-selected/clean/washb-kenya-table1.csv", comma replace

*save to shared folder
saveold "~/Dropbox/WBK-primary-analysis/Data/Final/Andrew/washb-kenya-table1.dta", replace version(12)
outsheet using "~/Dropbox/WBK-primary-analysis/Data/Final/Andrew/washb-kenya-table1.csv", comma replace
