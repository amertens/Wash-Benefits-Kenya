...
log using "C:/Users/andre/Documents/washb_Kenya_primary_outcomes_Andrew/Kenya cleaning .do files/5-kenya-dm-consort.log", text replace

*--------------------------------------------
* 5-kenya-dm-consort.do
*
...
* and carefully identify the eligible
...
*	washb-kenya-enrol.dta
*
* output files:
*	washb-kenya-track-compound.dta
*--------------------------------------------
...
*--------------------------------------------
use "~/dropbox/WBB-primary-analysis/Data/Untouched/3_Endline/01. WASHB_Midline_Endline_data_count_cleaned.dta", clear
...
saveold "~/dropbox/WBB-primary-analysis/data/final/ben/washb-bangladesh-track-compound.dta", version(12) replace
outsheet using "~/dropbox/WBB-primary-analysis/data/final/ben/washb-bangladesh-track-compound.csv", comma replace
